...
const Navbar = () => {
    return (
        <nav className="nav-container flex flex-col gap-3 lg:p-[10px_80px] sm:p-[10px_15px] p-[10px_16px]">
                ...
                <div className="flex flex-wrap gap-3">
                    <li className="color-white group relative">
                        ...
                        <div className="hidden group-hover:flex flex-col gap-3 absolute bg-blue-600 p-1 w-[200px] rounded-lg">
                            <Link>Air conditionar</Link>
                            <Link>Kitchen appliances</Link>
                            <Link>PCs and laptops</Link>
                            <Link>Gadegts</Link>
                            <Link>Smart home</Link>
                        </div>
                    </li>
                    <li><Link>Home appliances</Link></li>
                    <li><Link>Audio & video</Link></li>
                    <li><Link>Refrigrator</Link></li>
